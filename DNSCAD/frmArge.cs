...
namespace DNSCAD
{
    public partial class frmArge : Form
    {
        ...
        public string GetListData()
        {
            ...
            {
                string json = "";
                if (File.Exists(@"X:\mysexe\DNSCAD\DataJson\Arge\ArgeForm.json"))
                {
                    using (StreamReader r = new StreamReader(@"X:\mysexe\DNSCAD\DataJson\Arge\ArgeForm.json"))
                    {
                        json = r.ReadToEnd();
        ...
        public async Task GetFilesNcreateDataTask()
        {
            try
            {
                ...
                webBrowser1.Navigate(new Uri(@"X:\mysexe\DNSCAD\web\index2.html"));
        ...
        public class ScriptInterface
        {
            ...
            {
                DnsSearch.InsertRD(path);
            }
        }

        private void frmArge_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            this.Hide();
        }
        ...
        private void frmArge_VisibleChanged(object sender, EventArgs e)
        {
        ...
        private void frmArge_SizeChanged(object sender, EventArgs e)
        {
